"""
Card 1 — Pré-Rodada R9 Série B 2026
...
def create_sport_card():
    ...
    # Sport é MANDANTE → usar prob_home
    pct_value = SPORT_MATCH['prob_home'] * 100
    ...
    # Sport (mandante, GOLD) — empate (cinza médio) — CRB (visitante, cinza claro)
    ...
    img.save("pending_posts/2026-05-15_predicoes-r9/card_1_sport.png", quality=95)
