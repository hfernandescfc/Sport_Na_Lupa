"""
Card 3 — Demais jogos da Rodada 9
...
DEMAIS = [
    {"home": "Goiás", "home_id": 1960, "away": "Botafogo-SP", "away_id": 1979,
     "prob_home": 0.4030, "prob_draw": 0.3190, "prob_away": 0.2780, "result": "H"},
    {"home": "Cuiabá", "home_id": 49202, "away": "Grêmio Novorizontino", "away_id": 135514,
     "prob_home": 0.1000, "prob_draw": 0.4060, "prob_away": 0.4940, "result": "A"},
    {"home": "Athletic Club", "home_id": 342775, "away": "Juventude", "away_id": 1980,
     "prob_home": 0.1420, "prob_draw": 0.4910, "prob_away": 0.3670, "result": "D"},
    {"home": "Vila Nova FC", "home_id": 2021, "away": "Avaí", "away_id": 7315,
     "prob_home": 0.1910, "prob_draw": 0.4160, "prob_away": 0.3940, "result": "D"},
    {"home": "Ceará", "home_id": 2001, "away": "Fortaleza", "away_id": 2020,
     "prob_home": 0.1440, "prob_draw": 0.4070, "prob_away": 0.4500, "result": "A"},
]
...
def result_label(result: str) -> tuple[str, str]:
    """Retorna (label, accent_color) baseado no resultado mais provável."""
    if result == "H":
...
def create_demais_card():
    ...
    img.save("pending_posts/2026-05-15_predicoes-r9/card_3_demais.png", quality=95)
    print("[OK] Card 3 (Demais jogos) salvo")
