...
- `raio-x/README.md` — this file
- `raio-x/chats/` — conversation transcripts (read these!)
- `raio-x/project/` — the `Raio X` project files (HTML prototypes, assets, components)
