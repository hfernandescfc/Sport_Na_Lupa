"""
Card 2 — Top 4 Favoritos da Rodada 11
Convenção BR: mandante à esquerda, visitante à direita.
R11 — NENHUM favoritismo forte. Top 4 ficam entre 44% e 48%.
"""
from PIL import Image, ImageDraw, ImageFont
from pathlib import Path

FAVORITOS = [
    {"home": "Ceará", "home_id": 2001, "away": "Operário-PR", "away_id": 39634,
     "prob_home": 0.4791, "prob_draw": 0.2661, "prob_away": 0.2548},
    {"home": "Juventude", "home_id": 1980, "away": "América Mineiro", "away_id": 1973,
     "prob_home": 0.4785, "prob_draw": 0.2749, "prob_away": 0.2466},
    {"home": "Avaí", "home_id": 7315, "away": "Criciúma", "away_id": 1984,
     "prob_home": 0.4484, "prob_draw": 0.3302, "prob_away": 0.2213},
    {"home": "São Bernardo", "home_id": 47504, "away": "Grêmio Novorizontino", "away_id": 135514,
     "prob_home": 0.4435, "prob_draw": 0.3155, "prob_away": 0.2410},
]
...
def create_favoritos_card():
    ...
    out_path = "pending_posts/2026-05-29_predicoes-r11/card_2_favoritos.png"
    img.save(out_path, quality=95)
    print(f"[OK] Card 2 (Favoritos) salvo: {out_path}")
